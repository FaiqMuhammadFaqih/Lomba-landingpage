...
function taskReducer(tasks, aksi) {
  switch (aksi.type) {
    case "added": {
      return [...tasks, { id: aksi.id, text: aksi.text, done: false }];
    }
    case "deleted": {
      return tasks.filter((t) => t.id !== aksi.id);
    }
    case "changed": {
      return tasks.map((t) => {
        if (t.id === aksi.task.id) {
          return aksi.task;
        } else {
          return t;
        }
    ...
    default: {
      throw Error("Aksi sulit dimengerti!" + aksi.type);
    }
  }
}
...
const Main = () => {
  ...
  return (
    <>
      <h1 id="tx" className="py-6 font-bold text-tl">
        ...
        <table className="table-auto border-collapse border border-slate-500 ">
          <thead>
            <tr>
              ...
              <th className="border border-100">Aksi</th>
            </tr>
          </thead>
          <tbody>
            <Input3
